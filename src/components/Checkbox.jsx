...
import './HoloGraphicCheckbox.css';
    ...
    <div>
        ...
        <label className="holo-checkbox" htmlFor="holo-check">
            ...
            <div className="activation-rings">
                {[...Array(3)].map((_, i) => (
                <div className="activation-ring" key={i} />
                ))}
            </div>
        ...
        <div className="frequency-spectrum">
            {[...Array(20)].map((_, i) => (
            <div className="frequency-bar" key={i} />
            ))}
        </div>
        <div className="data-chips">
            <div className="data-chip1" />
            <div className="data-chip">Why ROTARACT CRCE?</div>
            <div className="data-chip">Reviewing You.....</div>
            <div className="data-chip">Applicant No. xxx</div>
        </div>
        </div>

        {/* ✅ Show Form if checkbox is checked */}
        {isChecked && <FuturisticForm />}
    </div>
    </StyledWrapper>
);
};
...
.grid-plane {
    ...
    linear-gradient(90deg, ##595757 1px, transparent 1px);
